...
export const PlaneDepartIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M15 22H9a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2Z" />
        <path d="m21.5 16-3.1-4.8c-.5-.7-1.4-1.2-2.4-1.2H14" />
        <path d="m2.5 8 3.1 4.8c.5.7 1.4 1.2 2.4 1.2H10" />
    </svg>
);
...
export const SightseeingIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ActivityIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m13.2 21.8-3.4-3.4" />
        <path d="m10.8 18.4 3.4 3.4" />
        <path d="M12 22a7 7 0 0 0 7-7c0-2-1-3-2-3s-2.5 1.5-3.5 2.5-2 2.5-3 2.5-1.5-1-2.5-2-1.5-2.5-2.5-2.5-2 1-2 3a7 7 0 0 0 7 7Z" />
        <path d="m14 4 3 3" />
...
export const AccommodationIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M2 8.2c0-1.5.9-2.8 2.3-3.2" />
        <path d="m22 8.2c0-1.5-1-2.8-2.3-3.2" />
        <path d="M15 11h.01" />
        <path d="M11 11h.01" />
        <path d="M7 11h.01" />
        <path d="M22 12v4.8c0 1.5-.9 2.8-2.3 3.2" />
        <path d="M2 12v4.8c0 1.5.9 2.8 2.3 3.2" />
        <path d="M17 19.8c-1.5.4-3.2.6-4.9.6-1.8 0-3.5-.2-5.1-.6" />
        <path d="M17 5c-1.5-.4-3.2-.6-4.9-.6-1.8 0-3.5.2-5.1-.6" />
    </svg>
);
...
export const PiggyBankIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M10 17V8c0-1.1.9-2 2-2h2a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-2" />
        <path d="M2 12c0-3.3 2.7-6 6-6h8c3.3 0 6 2.7 6 6v3c0 1.7-1.3 3-3 3h-1" />
        <path d="M2 12h1" />
        <path d="M17 12h1" />
        <path d="M21 12a2 2 0 0 0-2-2h-1" />
        <path d="M6 18h8" />
        <path d="M10 22V18" />
        <path d="M14 22V18" />
    </svg>
...
// New Icons for Itinerary Report
...
export const CarIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14 16H9m10-4H5a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2z" />
...
export const CloudSunIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 16.5A4.5 4.5 0 1 0 7.5 12h9a4.5 4.5 0 1 0 0-9h-1.3A6.5 6.5 0 0 0 2.5 9.5" />
        <path d="M20 5H10" />
    </svg>
);
...
export const ScooterIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M14 5.5H8.5l-2 6h3.5" />
        <path d="M9 17.5h8.5V15H15l-3-9.5h-2L7 15h2.5" />
    </svg>
);
